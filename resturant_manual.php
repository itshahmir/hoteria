          ...
          <div class="col-8">
            ...
            <div class="col mt-4">
              <div class="form-check">
                <input type="submit" class="btn btn-warning m-1 hover-zoom toggle-btn_1" onclick="show_loader()" name="add_order_manual" value="Submit" id="submit" style="width:120px;">
              </div>
            </div>
          </div>
