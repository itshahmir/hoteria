            ...
            <div class="row align-items-center">
             ...
             <div class="row align-items-center">
              <div class="col-10 mt-4">
                <input type="text" class="form-control" placeholder="Cnic" name="cnic" id="cnc" value="<?php echo $array[4]; ?>">
              </div>
               <div class="col-2 mt-4">
               <button class="btn btn-primary" id="scn" type="button" onclick="FastDownload()">Scan</button>
              </div>

            </div>
            <div class="row align-items-center mt-4">
              <div class="col">
                <input type="phone" class="form-control" placeholder="Phone" name="number_n" value="<?php echo $array[2]; ?>">
              </div>
            </div>
                              <div class="row align-items-center mt-4">
                     <div class="col">
