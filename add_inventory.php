                    ...
                    <form action="process.php" method="POST" id="inputform">
                        ...
                        <div class="row align-items-center mt-4">
                            <div class="col">
                                ...
                                <option>Nestle Mineral Water</option>
                            </div>
                        </div>
                        <div class="row align-items-center mt-4">
                            <div class="col mt-4">
                        ...
                        <div class="row align-items-center mt-4">
                            ...
                            <div class="col">
                                <input type="submit" onclick="show_loader()" value="Add Items" class="btn btn-primary m-1 hover-zoom toggle-btn_1" name="add_inventory">
                            </div>
                        </div>
