...
<body onload="show_month()" onkeydown="if(event.keyCode == 107){add_row()}" style="background-color: #a3a3a347;">
    ...
    <div class="col text-center mt-5">
        ...
        <!-- <input type="date" id='gMonth1' onchange="show_month()" data-date-format="DD MMMM YYYY" value="<?php echo $database->getBillingDate(); ?>"> -->
    ...
    <div class="m-5">
        <script type="text/javascript">
            ...
            function add_row() {
                ...
                var fs = [];
                fs[sr] = new Function('amount', 'details', 'date', 'var xhttp = new XMLHttpRequest(); xhttp.open("GET", "add_expenses_personal_ajax.php?date="+date+"&details="+details+"&amount="+amount+"", true);xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");xhttp.send();');
        ...
        <div class="fdb-block container" id="datata"></div>
    </div>
    ...
    <script type="text/javascript">
        function show_month() {
            ...
            $.post("expensesheet_personal_ajax.php", {
                    date: month
                },
