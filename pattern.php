...
<style>
table { margin-left: 0.7in; margin-right: 0.7in; margin-top: 0.75in; margin-bottom: 0.75in; }
</style>
...
for ($i=0; $i < count($users); $i++) { 
	...
	<tr class="row0">
            ...
            <td class="column2 style3 null style6" rowspan="2"></td>
 ...
 echo '<tr class="row4">
		...
		for ($keyi=0; $keyi < count($listOfRecievables); $keyi++) { 
            ...
            <td class="column1 style15 n">'.$listOfRecievables[$keyi][4].'</td>
